...
let AppService = class AppService {
    ...
    createUser(createUser) {
        ...
        this.client.emit('user_created', new create_user_event_1.CreateUserEvent(createUser.email));
        this.analyticsClient.emit('user_created', new create_user_event_1.CreateUserEvent(createUser.email));
    }
    getAnalytics() {
